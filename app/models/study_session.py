import uuid
from sqlalchemy import Column, ForeignKey, TIMESTAMP, func, Integer, Float, String
...
class StudySession(Base):
    ...
    concept_id = Column(PG_UUID(as_uuid=True), ForeignKey("learning_concepts.id", ondelete="CASCADE"), nullable=False)
