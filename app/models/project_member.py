...
import uuid
from sqlalchemy import Column, String, Boolean, ForeignKey, TIMESTAMP, JSON, func
...
class ProjectMember(Base):
    ...
    invited_by = Column(PG_UUID(as_uuid=True), ForeignKey("users.id", ondelete="SET NULL"), nullable=True)

    role = Column(String(20), default="member", nullable=False)  # owner, admin, member, invitee
    status = Column(String(20), default="active", nullable=False)  # active, pending, removed
